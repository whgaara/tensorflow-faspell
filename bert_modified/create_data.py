...
def main(fname):
    ...
    for line_c, line_w in zip(open('correct.txt', 'r', encoding='utf-8'), open('wrong.txt', 'r', encoding='utf-8')):
        if line_c.strip():
    ...
    pickle.dump(proportions, open('mask_probability.sav', 'wb'))
...
def parse_args():
    ...
    parser.add_argument('--file', '-f', type=str, default='../data/qa_train_10.txt',
...
if __name__ == '__main__':
    ...
    wrong_file = open('wrong.txt', 'w', encoding='utf-8')
    correct_file = open('correct.txt', 'w', encoding='utf-8')
    # main(args.file, args.output)
    main(args.file)
    f = open('mask_probability.sav', 'rb')
    t = pickle.load(f)
    print(t)
